<?php if ( ! defined( 'ABSPATH' ) ) { exit; }
	...
	$img_size = array( 'one-column' => 'full', 'one-half-column' => 'elearni-blog-ii-column', 'one-third-column' => 'elearni-blog-iii-column', 'one-fourth-column' => 'elearni-blog-iv-column' );
	...
	elseif( has_post_thumbnail( $post_ID ) ) : ?>
		<a href="<?php echo get_permalink($post_ID);?>" title="<?php printf(esc_attr__('Permalink to %s','elearni'), get_the_title($post_ID));?>">
