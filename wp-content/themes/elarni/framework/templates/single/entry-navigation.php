<?php if ( ! defined( 'ABSPATH' ) ) { exit; } ?>
    ...
    <div class="post-prev-link"><?php
		...
		if( !empty( $prev_post ) ):
			...
			<div class="nav-title-wrap">
                <p><?php esc_html_e('Previous Story','elearni'); ?></p>
                <span class="fas fa-long-arrow-alt-left"></span>
                <h3><a href="<?php echo get_permalink( $prev_post->ID ); ?>" title="<?php echo esc_attr($prev_post->post_title); ?>"><?php echo esc_attr($prev_post->post_title); ?></a></h3>
            </div>    
        <?php endif; ?></div>
    ...
    <div class="post-next-link"><?php
		...
		if( !empty( $next_post ) ):
			...
			<div class="nav-title-wrap">
                <p><?php esc_html_e('Next Story','elearni'); ?></p>
                <span class="fas fa-long-arrow-alt-right"></span>
                <h3><a href="<?php echo get_permalink( $next_post->ID ); ?>" title="<?php echo esc_attr($next_post->post_title); ?>"><?php echo esc_attr($next_post->post_title); ?></a></h3>
            </div>    
        <?php endif; ?></div>