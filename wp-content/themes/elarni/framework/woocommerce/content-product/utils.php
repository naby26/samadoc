...
if ( ! function_exists( 'dt_sc_woo_default_product_settings' ) ) {
	...
	function dt_sc_woo_default_product_settings() {
		...
		$settings["template-title"]                                 = esc_html__('DT Elearni', 'elearni');
		$settings["product-style"]                                  = "product-style-default";
		$settings["product-hover-styles"]                           = "product-hover-fade-gradientborder";
		$settings["product-overlay-bgcolor"]                        = "";
		$settings["product-overlay-effects"]                        = "";
		$settings["product-hover-image-effects"]                    = "product-hover-image-scalein";
		$settings["product-hover-secondary-image-effects"]          = "product-hover-secimage-fade";
		$settings["product-content-hover-effects"]                  = "";
		$settings["product-icongroup-hover-effects"]                = "product-icongroup-hover-bounce";
		...
		$settings["product-label-design"]                           = "product-label-circle";
		...
		$settings["product-thumb-alignment"]                        = "product-thumb-alignment-bottom-left";
		$settings["product-thumb-iconsgroup-icons"]                 = array ( 'cart', 'wishlist' );
		$settings["product-thumb-iconsgroup-style"]                 = "product-thumb-iconsgroup-style-bgfill-rounded-square";
		...
		$settings["product-content-alignment"]                      = "product-content-alignment-left";
	...
	function dt_sc_woo_shop_products_class() {
		...
		if($product_style_templates) {
			...
			/* "Product Style" */
				...
				if(isset($product_style_templates['product-custom-class']) && $product_style_templates['product-custom-class'] != '') {
...
if ( ! function_exists( 'elearni_product_style_setup_template_prop' ) ) {

	function elearni_product_style_setup_template_prop($woo_product_style_template) {
...
if ( ! function_exists( 'elearni_product_style_reset_template_prop' ) ) {

	function elearni_product_style_reset_template_prop() {
...
if ( ! function_exists( 'elearni_woo_post_display_mode_from_location' ) ) {

	function elearni_woo_post_display_mode_from_location($woo_product_style_template) {
...
if ( ! function_exists( 'elearni_woo_post_class' ) ) {

	function elearni_woo_post_class($classes, $class = '', $post_id = '') {
	 ...
	 add_filter('post_class', 'elearni_woo_post_class', 21, 3 );

}

/** Updating Product Category Loop Class **/

if ( ! function_exists( 'elearni_woo_product_cat_class' ) ) {

	function elearni_woo_product_cat_class($classes, $class = '', $category) {
	...
	add_filter('product_cat_class', 'elearni_woo_product_cat_class', 21, 3 );
...
if ( ! function_exists( 'elearni_woo_loop_product_button_elements_cart' ) ) {

	function elearni_woo_loop_product_button_elements_cart() {
		...
		if( !empty($add_to_cart) ) {
			...
			echo '<div class="wcct_btn_wrapper wc_btn_inline" data-tooltip="'.esc_attr__('Add To Cart', 'elearni' ).'">'.elearni_html_output($add_to_cart).'</div>';

		}

	}

	add_action( 'dt_woo_loop_product_button_elements_cart', 'elearni_woo_loop_product_button_elements_cart' );

}

// Wishlist

if ( ! function_exists( 'elearni_woo_loop_product_button_elements_wishlist' ) ) {

	function elearni_woo_loop_product_button_elements_wishlist() {
		...
		if ( shortcode_exists( 'yith_wcwl_add_to_wishlist' ) ) {
			...
			echo '<div class="wcwl_btn_wrapper wc_btn_inline" data-tooltip="'.esc_attr__('Wishlist', 'elearni' ).'">'.do_shortcode('[yith_wcwl_add_to_wishlist product_id="' . $product_id . '"]').'</div>';

		}

	}

	add_action( 'dt_woo_loop_product_button_elements_wishlist', 'elearni_woo_loop_product_button_elements_wishlist' );

}

// Quick View

if ( ! function_exists( 'elearni_woo_loop_product_button_elements_quickview' ) ) {

	function elearni_woo_loop_product_button_elements_quickview() {
		...
		if ( shortcode_exists( 'yith_quick_view' ) ) {
			...
			echo '<div class="wcqv_btn_wrapper wc_btn_inline" data-tooltip="'.esc_attr__('Quick View', 'elearni' ).'">'.do_shortcode('[yith_quick_view product_id="' . $product_id . '"]').'</div>';
		
		}

	}

	add_action( 'dt_woo_loop_product_button_elements_quickview', 'elearni_woo_loop_product_button_elements_quickview' );

}

// Compare

if ( ! function_exists( 'elearni_woo_loop_product_button_elements_compare' ) ) {

	function elearni_woo_loop_product_button_elements_compare() {
		...
		if( class_exists( 'YITH_Woocompare' ) ) {
			...
			$button_text = get_option( 'yith_woocompare_button_text', esc_html__( 'Compare', 'elearni' ) );
			...
			echo '<div class="wccm_btn_wrapper wc_btn_inline" data-tooltip="'.esc_attr__('Compare', 'elearni' ).'"><a href="'.esc_url_raw( add_query_arg( $url ) ).'" class="'.esc_attr($class).'" data-product_id="'.esc_attr($product->get_id()).'" rel="nofollow">'.elearni_html_output($button_text).'</a></div>';

		}

	}

	add_action( 'dt_woo_loop_product_button_elements_compare', 'elearni_woo_loop_product_button_elements_compare' );

}

// Swatches

if ( ! function_exists( 'elearni_woo_loop_product_button_elements_swatches' ) ) {

	function elearni_woo_loop_product_button_elements_swatches() {

		// Swatches
		elearni_woo_loop_product_content_swatches();

	}

	add_action( 'dt_woo_loop_product_button_elements_swatches', 'elearni_woo_loop_product_button_elements_swatches' );

}

// Size Guide

if ( ! function_exists( 'elearni_woo_loop_product_button_elements_sizeguide' ) ) {

	function elearni_woo_loop_product_button_elements_sizeguide() {
		...
		if($single_product_size_guides) {
			...
			echo '<div class="wcsg_btn_wrapper wc_btn_inline" data-tooltip="'.esc_attr__('Size Guide', 'elearni' ).'"><a href="#" class="button dt-wcsg-button" data-product_id="'.esc_attr($product->get_id()).'">'.esc_html__('Size Guide', 'elearni' ).'</a></div>';

		}

	}

	add_action( 'dt_woo_loop_product_button_elements_sizeguide', 'elearni_woo_loop_product_button_elements_sizeguide' );
