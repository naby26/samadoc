    <div class="dt-sc-posts-list-wrapper"><?php
        ...
        if( have_posts() ):
            ...
            $meta = $obj->elearni_post_meta_fields(false);
        ...
        if( $pagination == 'older_newer' ): ?>
            ...
            <div class="pagination blog-pagination">
                <div class="newer-posts"><?php echo get_previous_posts_link( '<i class="fas fa-angle-left"></i>'.esc_html__(' Newer Posts', 'elearni') ); ?></div>
                <div class="older-posts"><?php echo get_next_posts_link( esc_html__('Older Posts ', 'elearni').'<i class="fas fa-angle-right"></i>' ); ?></div>
            </div><?php

        elseif( $pagination == 'numbered' ): ?>

            <div class="pagination blog-pagination"><?php echo elearni_pagination(); ?></div><?php
