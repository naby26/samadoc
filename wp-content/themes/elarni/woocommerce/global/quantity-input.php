...
if ( $max_value && $min_value === $max_value ) {
	...
	$labelledby = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'elearni' ), strip_tags( $args['product_name'] ) ) : '';
	...
	<div class="quantity <?php echo esc_attr($plusminus_class); ?>">
		...
		?>
		<label class="screen-reader-text" for="<?php echo esc_attr( $input_id ); ?>"><?php esc_html_e( 'Quantity', 'elearni' ); ?></label>
		<input
			type="text"
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'elearni' ); ?>"
			size="4"
